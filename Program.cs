...
class Program
{
    ...
    public static void Main(string[] args)
    {
        ...
        GameObjectCreator<ChessObject>.AddToGrid(0, 'f', new MyVector2(0, 0), new MyVector2(7, 1), ConsoleColor.DarkGreen);
        GameObjectCreator<ChessObject>.AddToGrid(1, 'T', new MyVector2(0, 6), new MyVector2(7, 7), ConsoleColor.Blue);
        GameObjectCreator<ChessObject>.AddToGrid(1, 'p', new MyVector2(3, 7), new MyVector2(4, 7), ConsoleColor.Yellow);
